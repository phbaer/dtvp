...
def build_tmrescore_route_deps(
    *,
    ...
    return TMRescoreRouteDeps(
        ...
        run_tmrescore_analysis_task=lambda task, settings, project_name, threatmodel_bytes, synthetic_sbom, dtvp_original_proposals, items_csv_bytes, config_bytes, chain_analysis, prioritize, what_if, enrich, mitre_enrichment, offline: (
