...
- `mock_tmrescore.py` provides the in-memory VScorer API, service UI, and browser wizard placeholder.
...
- VScorer API/UI/Wizard: `http://127.0.0.1:8090`
...
- `mock_tmrescore.py`: In-memory VScorer mock with session, result, validator, editor, and wizard endpoints.
