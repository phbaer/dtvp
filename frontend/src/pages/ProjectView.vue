...
<template>
  <div class="overflow-x-visible min-h-0">
        <div class="flex flex-wrap w-full gap-y-10 pt-2.5 pb-8 lg:gap-x-4 lg:pt-0" data-testid="project-view-layout">
                <div class="min-w-min w-full lg:flex-1 max-w-full pl-0 lg:pl-0 lg:-ml-2" data-testid="project-view-content-column">
            ...
            <div v-else class="shadow-xl bg-white/2 border border-white/5 rounded-2xl backdrop-blur-sm min-w-min overflow-x-auto overflow-y-hidden">
                <div class="p-3 space-y-3">
                    <div v-if="viewMode === 'analysis'" class="min-w-min space-y-3" data-testid="vuln-list-area">
                        <VulnGroupCard
        ...
        <div class="hidden lg:block lg:w-[440px] lg:min-w-min lg:shrink-0 lg:sticky lg:top-24 lg:self-start lg:max-h-[calc(100vh-10rem)] lg:overflow-y-auto" data-testid="project-view-sidebar-column">
            <StatsSidebar
                :filters="filterState"
